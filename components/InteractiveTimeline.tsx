...
export default function InteractiveTimeline() {
  ...
  return (
    ...
    {/* Building Today Section - Separate from Timeline */}
            ...
            <div className="space-y-10">
              ...
              <div className="text-left">
                ...
                <div className="grid gap-6">
                  ...
                  <div className="group bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30 border-2 border-green-200 dark:border-green-700 p-6 rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-[1.02] hover:border-green-400 dark:hover:border-green-500">
                  ...
                  {/* AI Focus Area */}
                  <div className="group bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 border-2 border-blue-200 dark:border-blue-700 p-6 rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-[1.02] hover:border-blue-400 dark:hover:border-blue-500">
                    <div className="flex items-start gap-4">
                  ...
                  <div className="group bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 border-2 border-purple-200 dark:border-purple-700 p-6 rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-[1.02] hover:border-purple-400 dark:hover:border-purple-500">
                    <div className="flex items-start gap-4">
              ...
              {/* Impact Statement */}
              <div className="text-center pt-6 border-t border-stone-300 dark:border-stone-500">
